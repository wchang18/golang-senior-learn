...
const (
	Pay_GetPayCode_FullMethodName = "/pay.pb.Pay/GetPayCode"
)
...
func (c *payClient) GetPayCode(ctx context.Context, in *PayCodeReq, opts ...grpc.CallOption) (*PayCodeRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PayCodeRes)
	err := c.cc.Invoke(ctx, Pay_GetPayCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PayServer interface {
	GetPayCode(context.Context, *PayCodeReq) (*PayCodeRes, error)
...
func (UnimplementedPayServer) GetPayCode(context.Context, *PayCodeReq) (*PayCodeRes, error) {
...
func _Pay_GetPayCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PayCodeReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PayServer).GetPayCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Pay_GetPayCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PayServer).GetPayCode(ctx, req.(*PayCodeReq))
	}
...
var Pay_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pay.pb.Pay",
	HandlerType: (*PayServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetPayCode",
			Handler:    _Pay_GetPayCode_Handler,
		},
	},
